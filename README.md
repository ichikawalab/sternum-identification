...
characteristic curves, and rank-derived mean within-query AUC.
...
05_statistics/crossfit_selection_audit.py
...
Scripts retained only for provenance of earlier exploratory analyses live in
[`legacy/`](legacy/) and are not part of the current workflow.
