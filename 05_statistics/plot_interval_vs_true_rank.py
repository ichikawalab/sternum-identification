...
uv run python 05_statistics/plot_interval_vs_true_rank.py \
    --analysis_csv outputs/statistics/interval_vs_true_rank/interval_rank_analysis.csv \
    --output_tiff outputs/statistics/interval_vs_true_rank/interval_vs_true_rank.tiff
"""
